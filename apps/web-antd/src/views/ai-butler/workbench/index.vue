  ...
  <div :class="pageGapClass">
    ...
    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2 lg:gap-3.5">
      <Card :bordered="false" :class="cardClass">
        <template #title>
          <div class="flex items-center justify-between">
            <span class="text-[12.5px] font-bold text-[#0A0A0A] sm:text-[13px]">设备连接状态</span>
        ...
        <ul class="m-0 list-none p-0">
          ...
          >
            ...
            <span class="ml-auto text-[10.5px] text-[#71716B] sm:text-[11px]">{{
              device.meta
            }}</span>
          </li>
        </ul>
      ...
      <Card :bordered="false" :class="cardClass">
        <template #title>
          <div class="flex items-center justify-between">
            <span class="text-[12.5px] font-bold text-[#0A0A0A] sm:text-[13px]">最新动态</span>
            <button
              type="button"
